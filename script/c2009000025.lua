...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Ritual Summon
	local e3=Ritual.CreateProc(c,RITPROC_GREATER,aux.FilterBoolFunction(Card.IsType,TYPE_PLANT),nil,aux.Stringid(id,2),nil,nil,nil,nil,LOCATION_HAND|LOCATION_GRAVE)
