...
--link summon
	...
	c:RegisterEffect(e2)
	--Special summon 1 "Penguin" monster face-down to your field
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_PENGUIN) and not c:IsCode(2009000004) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
